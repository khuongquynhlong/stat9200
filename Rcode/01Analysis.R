...
df <- df |>
  mutate(
    ...
    anc_cat3 = factor(anc_cat3, labels = c("ANC<4", "ANC4-7", "ANC8+")),
    anc_cat3_cut15 = factor(anc_cat3_cut15, labels = c("ANC<4", "ANC4-7", "ANC8-15")),
    anc_cat3_cut12 = factor(anc_cat3_cut12, labels = c("ANC<4", "ANC4-7", "ANC8-12")),
